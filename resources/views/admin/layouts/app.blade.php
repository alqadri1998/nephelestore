...
<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled aside-enabled aside-static" style="background-image: url(/assets/admin/media/bg/400.jpg)">
