			...
			<div class="card card-custom card-stretch gutter-b">
				...
				<div class="d-flex align-items-center mb-10">
					<div class="d-flex flex-column flex-grow-1 font-weight-bold">
						<a class="text-dark text-hover-primary mb-1 font-size-lg">{{ __('الاسم بالعربية') }}</a>
						<span class="text-muted">{{ $category->translate('ar')->name }}</span>
					</div>
				</div>
				<div class="d-flex align-items-center mb-10">
					<div class="d-flex flex-column flex-grow-1 font-weight-bold">
						<a class="text-dark text-hover-primary mb-1 font-size-lg">{{ __('الاسم بالانجليزية') }}</a>
				...
				<div class="d-flex align-items-center mb-10">
					<div class="d-flex flex-column flex-grow-1 font-weight-bold">
						<a class="text-dark text-hover-primary mb-1 font-size-lg">{{ __('الوصف بالعربية') }}</a>
						<span class="text-muted">{{ $category->translate('ar')->description }}</span>
					</div>
				</div>
				<div class="d-flex align-items-center mb-10">
					<div class="d-flex flex-column flex-grow-1 font-weight-bold">
						<a class="text-dark text-hover-primary mb-1 font-size-lg">{{ __('الوصف بالانجليزية') }}</a>
