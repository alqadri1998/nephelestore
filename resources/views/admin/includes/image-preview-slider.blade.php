<div class="image-input image-input-outline" id="kt_image_2">
    <div class="image-input-wrapper" style="background-image: url({{ isset($slider_item) && $slider_item->path ? $slider_item->path : 'https://via.placeholder.com/1180x470.png?text=Slider+Item+Here' }}); width: 1180px;height: 470px;"></div>
