        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('/assets/admin/media/bg/bg-3.jpg');">
                    ...
                    <form class="" method="post" action="{{route('admin.forget-password.post')}}">
                        {{csrf_field()}}
                        @if (isset($errors))
                        ...
                        <div class="form-group group_phone_login">
                            <input type="tel" id="phone_login" placeholder="{{t('Email')}}" class="form-control phone_login" name="email">
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary d-block w-100">{{  t('reset-password') }}</button>
                        </div>
                    </form>
                        </div>
