                ...
                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                            aria-controls="home" aria-selected="true">{{ t('Payment', 'site') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                            aria-controls="profile" aria-selected="false"> {{ t('Payment', 'site') }} - Tamara </a>
                    </li>
                        ...
                        <form action="booking-success.html">
                            <div class="payment-widget">
                                ...
                                <div class="payment-list">
                                    <div class="mysr-form">
                                        <div class="mysr-form-alertContainer"><span id="string"
                                                class="mysr-form-inputAlert mysr-form-alertDanger"></span></div>
                                    </div>
                                </div>
                                <!-- /Credit Card Payment -->
                        ...
                        <tfoot>
                            ...
                            @if ($order->discount > 0)
                                <tr class="cart-subtotal">
                                    ...
                                    <td class="price-col">
                                        <span>{{ number_format($order->discount, 2) . ' ' . t('SAR', 'site') }}</span>
                                    </td>
                                </tr class="cart-subtotal">
                            @endif
                            <tr>
                                <td>
                                    <h4>{{ t('Shipping Price', 'site') }}</h4>
                                </td>
                                <td class="price-col">
                                    <span>{{ number_format($order->shipping_price, 2) . ' ' . t('SAR', 'site') }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="price-col">
                                    <span>{{ number_format($order->vatAmount, 2) . ' ' . t('SAR', 'site') }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="price-col">
                                    <span>{{ number_format($order->total, 2) . ' ' . t('SAR', 'site') }}</span>
                                </td>
                            </tr>
    ...
    @section('scripts')
        ...
        <script>
            Moyasar.init({
                ...
                publishable_api_key: 'pk_live_brrAqbaWDwu2BksGu9QUtpksazfPwa4zTd9KmqfB',
