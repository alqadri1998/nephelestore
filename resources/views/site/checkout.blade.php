    ...
    <div class="container">
        ...
        @if (!Auth::check())
            <div class="login-form-container">
                ...
                <button data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"
                    class="btn btn-link btn-toggle">{{ t('Login', 'site') }}</button>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}" type="email"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="mb-0 pb-1">{{ t('Password', 'site') }} <span
                                                    class="required">*</span></label>
                                            <input dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}" type="password"
                                ...
                                <div class="form-footer mb-1">
                                    <div class="custom-control custom-checkbox mb-0 mt-0">
                                        ...
                                        <label class="custom-control-label mb-0"
                                            for="lost-password">{{ t('Remember me', 'site') }}</label>
                                    </div>

                                    <a href="{{ route('forgotPassword') }}"
                                        class="forget-password">{{ t('Forgot Password?', 'site') }}</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('checkout') }}" method="GET">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm" name="coupon_code"
                                ...
                                value="{{ isset($_GET['coupon_code']) ? $_GET['coupon_code'] : '' }}">
        ...
        <form action="{{ route('completeOrder') }}" method="post" id="checkout-form">
            ...
            <input type="hidden" name="coupon"
                value="{{ isset($_GET['coupon_code']) && !empty($_GET['coupon_code']) ? $_GET['coupon_code'] : '' }}">
            <div class="row">
                <div class="col-lg-7">
                        ...
                        <li>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile"
                                            value="{{ Auth::check() ? Auth::user()->mobile : '' }}" class="form-control"
                                            required {{ !Auth::check() ? 'disable' : '' }} />
                                    </div>
                                </div>
                            </div>
                                ...
                                <select name="area" class="form-control" id="areas">
                                    ...
                                    @foreach ($areas as $area)
                                        <option value="{{ $area->id }}"
                                            {{ Auth::check() && Auth::user()->area_id ? (Auth::user()->area_id == $area->id ? 'selected' : '') : '' }}>
                                            {{ $area->name }}</option>
                                    @endforeach
                            ...
                            <div class="form-group mb-1 pb-2">
                                ...
                                <input type="text" name="street_address" class="form-control"
                                    placeholder="{{ t('House number and street name', 'site') }}" required
                                    value="{{ Auth::check() ? Auth::user()->street_address : '' }}" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" class="form-control"
                                    placeholder="{{ t('Notes about your order, e.g. special notes for delivery.', 'site') }}"></textarea>
                            </div>
                        ...
                        <table class="table table-mini-cart">
                            ...
                            <tfoot>
                                ...
                                @if (isset($shipping))
                                    <tr class="cart-subtotal">
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="type_shpping" hidden id="type_shpping">
                                ...
                                @if ($discount > 0)
                                    <tr class="cart-subtotal">
                                        <td>
                                            <h4>{{ t('Discount', 'site') }}</h4>
                                        </td>
                                        <td class="price-col">
                                            <span>{{ number_format($discount, 2) . ' ' . t('SAR', 'site') }}</span>
                                        </td>
                                    </tr class="cart-subtotal">
                                @endif
                                {{-- <tr>
                            ...
                            <td class="price-col"><span>{{ number_format($shipping ,2) .' '.t('SAR','site')}}</span></td>
                                ...
                                <tr>
                                    <td>
                                        <h4>{{ t('Total including tax', 'site') }}</h4>
                                    </td>
                                    <td class="price-col">
                                        <span>{{ number_format($subTotal + $shipping + $vatAmount - $discount, 2) . ' ' . t('SAR', 'site') }}</span>
                                    </td>
                                </tr>
                                    ...
                                    <td class="text-left" colspan="2">
                                        ...
                                        <div class="form-group form-group-custom-control mb-0">
                                            <div class="custom-control custom-radio d-flex mb-0">
                                                <input type="radio" name="payment_method" class="custom-control-input"
                                                    value="credit">
                                                <label class="custom-control-label">
