	...
	var Porto = {
		...
		modalView: function() {
			$('body').on('click', '.btn-add-cart', function(e){
				if($(this).data('image')){
					$('.add-cart-box #productImage').attr('src', $(this).data('image'));
					$('.add-cart-box #productTitle').text($(this).data('title'));
				...
				if($(this).hasClass('simple')){
					...
					$('.add-cart-box #price-span-single').text($(this).data('price'));
				}
		...
		lightBox: function () {
			...
			$( 'body' ).on( 'click', 'a.btn-quickview', function ( e ) {
				...
				var ajaxUrl = '/api/product/quick_view?slug=' + $(this).attr('data-slug');

				// var ajaxUrl = '/api/product/quick_view?slug=sss';
